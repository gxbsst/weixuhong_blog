...
<div class="pagewrapper clearfix">
	...
	<div class="pagecontent">
		...
		<button id="tougao-submit" class="btn btn-primary"><i class="icon-ok-circle icon-white icon12"></i> 立即提交</button>
	</div>
</div>

<?php wp_enqueue_script( '', get_template_directory_uri() . '/js/tougao.js', array(), '2.0', true ); ?>
<?php get_footer(); ?>